...
const Contentright=()=>{
    return <div className="right">
        <div className="mybar"><div className="mybar_top"><img src="./img/1.jpg" alt=""className="headimg"/></div>
        <div className="mybar_bottom">
            ...
            <div className="icons-list"> 
               ...
               <Link to='/login'>
                   ...
                   <img src="https://static.leetcode-cn.com/cn-mono-assets/production/assets/logo-dark-cn.c42314a8.svg" alt="logo" class="css-1n67oxn-LightImg eewwj120"></img>
               
               </Link>
            </div>
            
            <h1 className="h11">专业前端</h1>
            <h1 className="h11">值得信赖</h1>
                </div>
                </div>
    </div>
}
